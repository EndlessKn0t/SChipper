...
#
module new schipper work:schipper:NOFILE -nosplit
...
load symbol schipper_regs work:schipper_regs:NOFILE HIERBOX pin clk input.left pin wen input.left pinBus raddr1 input.left [5:0] pinBus raddr2 input.left [5:0] pinBus rdata1 output.right [31:0] pinBus rdata2 output.right [31:0] pinBus waddr input.left [5:0] pinBus wdata input.left [31:0] boxcolor 1 fillcolor 2 minwidth 13%
...
fullfit
#
# initialize ictrl to current module schipper work:schipper:NOFILE
ictrl init topinfo |
